...
const sampleMultipleItems = [
    {
        ...
        rating: '4.19',
        reviews: [
            { rating: 5, comment: 'Very satisfied!', reviewerName: 'John', date: new Date().toISOString() },
            { rating: 1, comment: 'Very dissatisfied!', reviewerName: 'Jane', date: new Date().toISOString() },
            { rating: 3, comment: 'Very unhappy with my purchase!', reviewerName: 'Doe', date: new Date().toISOString() }
        ]
    },
    {
        availabilityStatus: "In Stock",
        description: "Crisp and hydtrating cucumbers, ideal for salads, snacks, or as a refreshing side",
        id: 21,
        title: 'cucumber',
        price: 1.49,
        quantity: 1,
...
describe('CartPage', () => {
    ...
    it('displays product details when cart has items', () => {
        ...
        expect(screen.getAllByText('1.49', { exact: false }).length).toBeGreaterThan(0); // Price displays twice in item total and item price
